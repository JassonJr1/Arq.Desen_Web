const data = [
  {
    ...
    questions: [
      {
        question: "Identifique o elemento HTML presente somente em HTML5",
        options: ["<figure>", "<frame>", "<iframe>", "<legend>"],
        answer: "<figure>",
        tip: "É um elemento semantico",
      },
      {
        question: "Em um documento HTML, o lugar correto para se declarar folhas de estilo CSS externas é dentro da seção:",
        options: ["<div>", "<head>", "<body>", "<title>"],
        answer: "<head>",
        tip: "É o mesmo elemnto usado para identificar a cabeça do documento HTML",
      },
      {
